...
type RegionKey =
  ...
  | "tulkarm"
  | "jaffa"
  | "alramla" // Fixed: removed hyphen from key name
  | "ramallah"
  | "jerusalem"
  | "gaza"
  | "hebron"
...
const REGIONS: Record<RegionKey, RegionMeta> = {
  ...
  alramla: { title: "al-Ramla", blurb: "White-domed crossroads between hills & sea." }, // Fixed: key changed to alramla
...
export default function PalestineHistoricMap() {
  ...
  // Highlight logic: add styling when active
  const highlight = (id: RegionKey) =>
    clsx("hover:fill-emerald-300 hover:cursor-pointer transition-colors duration-300 fill-white stroke-black", {
      "fill-emerald-300": active === id,
    })
    ...
    <div className="relative flex">
      ...
      >
        <path
          ...
          className={highlight("safad")}
          onMouseEnter={() => setActive("safad")}
          onClick={() => setActive("safad")}
        />
        <path
          id="acre"
          ...
          className={highlight("acre")}
          onMouseEnter={() => setActive("acre")}
          onClick={() => setActive("acre")}
        />
        <path
          id="tiberias"
          ...
          className={highlight("tiberias")}
          onMouseEnter={() => setActive("tiberias")}
          onClick={() => setActive("tiberias")}
        />
        <path
          id="haifa"
          ...
          className={highlight("haifa")}
          onMouseEnter={() => setActive("haifa")}
          onClick={() => setActive("haifa")}
        />
        <path
          id="nazareth"
          ...
          className={highlight("nazareth")}
          onMouseEnter={() => setActive("nazareth")}
          onClick={() => setActive("nazareth")}
        />
        <path
          id="baysan"
          ...
          className={highlight("baysan")}
          onMouseEnter={() => setActive("baysan")}
          onClick={() => setActive("baysan")}
        />
        <path
          id="jenin"
          ...
          className={highlight("jenin")}
          onMouseEnter={() => setActive("jenin")}
          onClick={() => setActive("jenin")}
        />
        <path
          id="tulkarm"
          ...
          className={highlight("tulkarm")}
          onMouseEnter={() => setActive("tulkarm")}
          onClick={() => setActive("tulkarm")}
        />
        <path
          id="jaffa"
          ...
          className={highlight("jaffa")}
          onMouseEnter={() => setActive("jaffa")}
          onClick={() => setActive("jaffa")}
        />
        <path
          id="nablus"
          ...
          className={highlight("nablus")}
          onMouseEnter={() => setActive("nablus")}
          onClick={() => setActive("nablus")}
        />
        <path
          id="ramallah"
          ...
          className={highlight("ramallah")}
          onMouseEnter={() => setActive("ramallah")}
          onClick={() => setActive("ramallah")}
        />
        <path
          id="alramla"
          ...
          className={highlight("alramla")}
          onMouseEnter={() => setActive("alramla")}
          onClick={() => setActive("alramla")}
        />
        <path
          id="jerusalem"
          ...
          className={highlight("jerusalem")}
          onMouseEnter={() => setActive("jerusalem")}
          onClick={() => setActive("jerusalem")}
        />
        <path
          id="gaza"
          ...
          className={highlight("gaza")}
          onMouseEnter={() => setActive("gaza")}
          onClick={() => setActive("gaza")}
        />
        <path
          id="hebron"
          ...
          className={highlight("hebron")}
          onMouseEnter={() => setActive("hebron")}
          onClick={() => setActive("hebron")}
        />
        <path
          id="beersheba"
          ...
          className={highlight("beersheba")}
          onMouseEnter={() => setActive("beersheba")}
